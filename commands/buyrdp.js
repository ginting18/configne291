...
module.exports={
    data: new SlashCommandBuilder()
        ...
        async execute(interaction){
            ...
            if (interaction.member.roles.cache.has(process.env.NAME_ROLE_TOBUYER_RDP) === false ){
            await interaction.member.roles.add(process.env.NAME_ROLE_TOBUYER_RDP);
            }
